...
class AtropineEnvGym(QuarticGymEnvBase):
    def __init__(self, dense_reward=True, normalize=True, debug_mode=False, action_dim=4,
                 ...
                 x0_loc='https://raw.githubusercontent.com/Quarticai/QuarticGym/master/quarticgym/datasets/atropineenv/x0.txt',
                 z0_loc='https://raw.githubusercontent.com/Quarticai/QuarticGym/master/quarticgym/datasets/atropineenv/z0.txt',
                 model_loc='https://github.com/Quarticai/QuarticGym/blob/master/quarticgym/datasets/atropineenv/model.npy?raw=true',
                 uss_subtracted=True, reward_on_ess_subtracted=False, reward_on_steady=True,
                 reward_on_absolute_efactor=False, reward_on_actions_penalty=0.0, reward_on_reject_actions=True,
                 relaxed_max_min_actions=False, observation_include_t=True, observation_include_action=False,
    ...
    def evalute_algorithms(self, algorithms, num_episodes=1, error_reward=-100000.0, initial_states=None, to_plt=True,
    ...
    def evaluate_rewards_mean_std_over_episodes(self, algorithms, num_episodes=1, error_reward=-100000.0,
