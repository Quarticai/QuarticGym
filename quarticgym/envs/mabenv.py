...
class MAbEnvGym(QuarticGymEnvBase):
    def __init__(
            self, dataset_dir='quarticgym/datasets/mabenv', dense_reward=True, normalize=True, debug_mode=False, action_dim=7+1+1, observation_dim=17+2+1951,
        ...
        Args:
            dataset_dir (str, optional): The dataset directory that has uss.npy, xss.npy, ulb.npy, uub.npy,
                xlb.npy, xub.npy. You could find it in 'quarticgym/datasets/mabenv' when you clone from github.
