...
To better assist any control algorithms, we also provided a canonical production process under this simulation. Please consult the 'profile_industrial' in the BeerFMT section `here <https://github.com/Quarticai/QuarticGym/blob/main/examples.ipynb>`_ for more details.

BeerFMTEnv module
-----------------

.. automodule:: quarticgym.envs.beerfmtenv
    :members:
    :undoc-members:
    :show-inheritance:
    :noindex:
