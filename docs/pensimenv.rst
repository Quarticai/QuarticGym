...
The Penicillin Fermentation Env aims to simulate the penicillin production process. The simulation itself is based on `PenSimPy <https://github.com/Quarticai/PenSimPy>`_ and `The development of an industrial-scale fed-batch fermentation simulation <https://www.sciencedirect.com/science/article/abs/pii/S0168165614009377>`_.
